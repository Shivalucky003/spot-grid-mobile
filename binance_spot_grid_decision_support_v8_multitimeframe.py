        ...
        for idx,symbol in enumerate(st.session_state.candidates):
            ...
            for name,candles,target in strategies:
                ...
                row={
                    ...
                    "Test Return %":c["total_return"],"Buy-Hold %":c["buy_hold"],"Test Alpha %":c["alpha"],
                    "Realized ROI %":c["realized_roi"],"Final Equity":c["final_equity"],"Max DD %":c["max_dd"],
                    "Profit Factor":c["profit_factor"],"Trades":c["trades"],"Cycles":c["cycles"],
                    "Skipped":c["skipped"],"Skipped %":c["skip_rate"],"Escape Bars":c["escapes"],
