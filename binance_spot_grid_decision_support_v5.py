...
# ============================================================
# BINANCE SPOT GRID DECISION SUPPORT - V5
# ============================================================
...
st.set_page_config(
    page_title="Binance Spot Grid Decision Support V5",
    layout="wide",
...
def get_http_session():
    ...
    session.headers.update({
        "User-Agent": "BinanceSpotGridDecisionSupport/5.0"
    })
    return session
...
def calculate_suitability_score(
    ...
    # --------------------------------------------------------
    # 10. Bollinger / volatility warning
    # --------------------------------------------------------
